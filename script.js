...
const MTE_CONFIG = {
  ...
  /* পরিচয় */
  subtitle: "মাদ্রাসা শিক্ষক | ইসলামিক লেখক | ইনচার্জ | ওয়েব ডেভলপার |",
...
books: [
  ...
  {
    title: "তৃতীয় বইয়ের নাম",
    author: "লেখকের নাম",
    cover: "তৃতীয় বইয়ের Cover URL",
    pdf: "তৃতীয় বইয়ের PDF URL"
  },

  {
    title: "চতুর্থ বইয়ের নাম",
    author: "লেখকের নাম",
    cover: "চতুর্থ বইয়ের Cover URL",
    pdf: "চতুর্থ বইয়ের PDF URL"
  },

  {
    title: "পঞ্চম বইয়ের নাম",
    author: "লেখকের নাম",
    cover: "পঞ্চম বইয়ের Cover URL",
    pdf: "পঞ্চম বইয়ের PDF URL"
  }
...
<div class="mte-grid">
  ...
  <section class="mte-section mte-section-soft">
    <div class="mte-container">
      ...
      <div class="mte-grid">
        <article class="mte-card"><div class="mte-video"><iframe src="https://www.youtube.com/embed/dQw4w9WgXcQ" title="ডেমো ভিডিও ক্লাস" loading="lazy" allowfullscreen></iframe></div><h3 class="mte-card-title">ডেমো ভিডিও ক্লাস</h3></article>
        <article class="mte-card"><div class="mte-video"><iframe src="https://www.youtube.com/embed/dQw4w9WgXcQ" title="ডেমো ইসলামিক শিক্ষা" loading="lazy" allowfullscreen></iframe></div><h3 class="mte-card-title">ইসলামিক শিক্ষা</h3></article>
        <article class="mte-card"><div class="mte-video"><iframe src="https://www.youtube.com/embed/dQw4w9WgXcQ" title="ডেমো কুরআন ক্লাস" loading="lazy" allowfullscreen></iframe></div><h3 class="mte-card-title">কুরআন ক্লাস</h3></article>
      </div>
    </div>
  </section>
  ...
  <section class="mte-section mte-section-soft">
    <div class="mte-container">
      ...
      <div class="mte-gallery">
        ...
        <button class="mte-gallery-item" onclick="mteOpenImage('https://images.unsplash.com/photo-1591604129939-f1efa4d9f7e8?auto=format&fit=crop&w=1200&q=85')"><img src="https://images.unsplash.com/photo-1591604129939-f1efa4d9f7e8?auto=format&fit=crop&w=600&q=80" alt="ইসলামিক বই" loading="lazy"></button>
